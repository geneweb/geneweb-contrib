...
type both_record = Old of old_gen_record | New of gen_record
  ...
  | Some ic ->
      (try
         let rec loop last_pos =
           try
             let pid =
               exec "/home/geneanet/is_gw_plus"
                 [ fname; string_of_int last_pos ]
    ...
    List.fold_left
      (fun hist both_gr ->
        ...
        | Old old_gr ->
            ...
            let gen_p =
              {
                ...
                sex = old_gen_p.old_sex;
                access = old_gen_p.old_access;
                birth = old_gen_p.old_birth;
                birth_place = old_gen_p.old_birth_place;
                birth_note = "";
                ...
                burial_note = "";
                burial_src = old_gen_p.old_burial_src;
                pevents = [];
            ...
            let gr =
              {
                date = old_gr.old_date;
                wizard = old_gr.old_wizard;
                gen_p;
                gen_f;
                gen_c = old_gr.old_gen_c;
              }
            in
            gr :: hist
        | New gr -> gr :: hist)
